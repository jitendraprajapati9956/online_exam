        ...
        <div class="segment_viva">
            <form action="" method="post">
                <table style="padding-left: 60px; padding-top: 35px">
                    ...
                    <tr>
                        <td>GitHub ID:</td>
                        <td><input name="facebook" type="text" id="facebook" required="" placeholder="Like: GitHub.com/"></td>
                    </tr>
                    <tr>
                        <td>Linkdin ID:</td>
                        <td><input name="skype" type="text" id="skype" placeholder="Enter Linkdin ID"></td>
                    </tr>
                    <tr>
                    <tr>
                        <td></td>
